...
**The collector RETURNS the file; it does not download it.** 2026-09-06: *"we are not
...
2026-09-06: *"on each individual we always grab the html family members and save them
