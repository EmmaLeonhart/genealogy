...
**The absences in that chain were never actually established.** A text search on the names, or
variants of them, on Wikidata is the minimum effort owed here.
*"We might basically find that that
...
**Nothing had established the absences.** The chain was called absent because no
...
for *finding candidates a human then judges*, which is what was asked for.

**2. Through another genealogy database.** Wikidata carries a dozen genealogical identifiers, and
they cross-reference each other: *"I think Wikidata does the best at entity resolution
