...
**It is kept separate from the post-1624 Itamar items on purpose.** You,
...
def main() -> int:
    ...
    # only knows a link once *Wikidata* states the `P2600`. You also writes the
    ...
    # You had linked yourself. You, 2026-08-16: *"I literally have an entire file
