...
**`Q232803` is imported here, not merely acknowledged.**

The item is matched to a Geni profile by hand but carries no `P2600`, so the
family walk that built the store never had a route to it. Nothing about it can
...
is done because it was asked for directly and it is a single item.
