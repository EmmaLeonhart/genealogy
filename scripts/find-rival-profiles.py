...
(a parent, or a child) and carry the same label.  Those are the pairs that
would otherwise have to be merged by hand.
"""
import collections
import csv
import io
...
def main():
    ...
    for r in rows(LEDGER):
        ...
        # An item that merely had a P2600 added was already on Wikidata, so it
