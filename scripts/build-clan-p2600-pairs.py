...
**The Tanba, Onakatomi and Izumo rosters are a prerequisite for the synoptic rebuild** —
these joins are **inputs** to `reports/synoptic-correspondence.tsv`, so
...
**The join is the key written into the profiles by hand.** Every one of them carries
...
def main():
    # geni_id -> qid, from the About Me link written into each profile by hand.
    qid_of = {}
