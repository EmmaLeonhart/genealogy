...
here — no route, a 404, a truncated body — cannot.
    ...
    python scripts/wikidata_lockout.py --noticeboard    # exit 0 = no 日巫女 on the noticeboard
"""
