...
**The ruling of 2026-08-24:** the Izumo chart edges are **succession, not parentage**. Two things
...
**Report, never correct.** `CLAUDE.md`: the purpose is to ADD, a disagreement is a note, and an
Izumo identity call is made by hand. Nothing here is emitted.
