...
the second hop is visible rather than assumed. You, 2026-08-16: *"It can work off of those
...
#: A `SURN` that is punctuation or a marker is not a family name. Your boundary, 2026-08-17:
#: **words yes, punctuation no** -- and you confirmed a surname of `.` becomes nothing.
...
def main() -> int:
    ...
    for g in sorted(unlabelled):
        ...
        if hit:
            ...
            # grandfather, and that is the long-range case you named.
