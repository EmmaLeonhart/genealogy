...
**your ruling, on `Maria`:** *"everything appears to be diacritics or stuff that's not actually
...
Extending your rule to the second shape is a decision taken rather than asked, per `CLAUDE.md`
