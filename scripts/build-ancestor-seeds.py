...
Choosing between the whole 2,123 and tighter cuts: the campaign is seeded from
the **829 targets born 1500s or later**.
...
#: The chosen cut. A `Descendants` export from a 1400s parent lands in the 1400s.
EARLIEST = 1500
