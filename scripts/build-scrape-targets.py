...
**You, 2026-08-18:** *"It is not worth six minutes to fill in something on the flat
...
**Every path member needs their OWN saved page.** You were emphatic, correcting the
...
**DO NOT RE-RUN THIS WHILE THE SAVING IS IN PROGRESS.** You, 2026-08-19:
...
your thirteen `8-19 exports` took it 1,824 -> 1,869, which is the script working
...
Your Descendants exports are filed in `exports/8-19 exports/` and are corpus like
any other; they are simply not allowed to redefine this list while it is being
worked. You keep your own copies separately and the two will be joined later.
