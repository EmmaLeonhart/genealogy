...
You, 2026-08-12: *"And family links. Noting that sibling relationships without
...
Matching is genealogical only — your governing rule — so nothing here uses a name
...
def join_names(names: list[str]) -> str:
    ...
    You gave the label format as *"father of x and y"*, which fixes the
