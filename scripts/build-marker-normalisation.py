...
**The instruction, in `queue.md` § LABELS, IN ORDER**, on the second of three marker
...
**This is the one of the three that needs no further ruling**, which is why it goes first. The
other two do:
