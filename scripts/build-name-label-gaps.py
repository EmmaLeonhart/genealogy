...
You, 2026-08-18: *"We're going to be, of course, having to add labels in other languages
...
cases to you rather than to a guess, and a wrong reading of a name is the kind of thing
...
#: your label ladder, 2026-08-18: `mul`, then `en`, then `ja`, then `zh`, then the
