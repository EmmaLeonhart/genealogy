...
**your queued item, in your words:** *"I think you should keep an active ledger, like a ledger
...
of the QIDs and figure things out."* You also called it *"a potential concern"* and *"too much of
...
rebuilds `reports/garborg-qids.tsv` from your contributions and calls `resolve-merged-qids.py`
...
* **Explains disagreements.** For each Geni id where the ledger and your contributions differ, asks
...
**Querying is allowed now** — You lifted the ban on 2026-08-29: *"You are completely 100% allowed
...
def main():
    ...
    # policies' half of your ruling; the cache lives beside the other Wikidata data.
