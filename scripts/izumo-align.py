...
You, 2026-08-20: *"Are you using text similarity instead of relational position?"*
...
is where you put an identity no computation could reach, and the ids recorded in
...
Geni three separate times - so they are reported for you to merge, never resolved
here.
"""
