...
| **one is the other's parent** | a generation has been collapsed on one side. Worth your eye: this is the shape that produced the Samaritan `exports/excluded/` case. |
...
merges are your and that the question is only ever whether our snapshot matches Geni — never
