...
written by hand into their Geni `about_me`, and emit the `add_geni_id` batch.
...
**It is impossible to merge these Geni profiles.** Geni forbids connecting biblical
people to living people, so users
