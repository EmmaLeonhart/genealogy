...
**The source for the Samaritans is the English Wikipedia list**, settled 2026-08-31:
`Samaritan High Priest`, which `List of Samaritan High Priests` redirects to. It
...
- `wdt:P39 wd:Q678510` returns **7 items**. That is the very inconsistency the `samaritans/
...
- `samaritans/wikidata.txt` is a dictation about the work, not a list.
