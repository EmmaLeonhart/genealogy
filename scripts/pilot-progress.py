...
So the item names this script instead of a count. `CLAUDE.md` § *The tree and the items are edited BY HAND, continuously* is the same rule for a different file: a photograph of a moving thing is
