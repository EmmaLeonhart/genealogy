...
at the time, a ban you lifted on 2026-08-29. A join through a stale copy does not fail; it
silently returns fewer rows.

**Measured on the first refresh, 2026-08-30: `reports/garborg-qids.tsv` went from 258 of 849
items resolving to 849 of 849.** Five hundred and ninety-one of your own items were invisible to
