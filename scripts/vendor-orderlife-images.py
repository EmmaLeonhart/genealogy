...
Images used by the wikibase are preserved; images sitting in the directory that
the wikibase does not use are not.
...
**The prediction was right, and the numbers say so rather than the other way
