...
**You, 2026-09-02, and it dissolves the culture problem rather than solving it:** *"the kana
...
* **`zh` is mechanical**, from Unihan's `kMandarin`, once `scripts/import-unihan.py` has run.
  4,682 of the 4,688 characters carry one. You authorised the download on 2026-09-02, choosing
