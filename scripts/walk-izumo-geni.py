...
Your seed, 6000000012789160423, is already in the merged tree, so the Geni
profiles for this clan do not have to be searched for one at a time -- they are
reachable by walking outward from you seed.
...
# far a match sits from your seed -- restricting the search to it was the second
