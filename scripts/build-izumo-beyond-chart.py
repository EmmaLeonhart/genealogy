...
Senge 77-81, eleven men `reports/izumo-roster.tsv` has no row for. They DO get Wikidata
items: that is what the roster is for, and they are part of the Geni individual creation
pipeline.

**Ten of the eleven already have items, linked by hand.** Their About Me
...
def main():
    obj = {
        ...
        'requires': [],
        'anchor': None,
        # The regnal number is NOT part of the name -- flagged when the
        ...
        # The label form follows the roster's for this lineage; worth a read.
