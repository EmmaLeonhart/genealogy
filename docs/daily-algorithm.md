...
it and loses in any disagreement. You, 2026-08-26, on why the spec is dictated so rigidly:
...
**You, 2026-08-26:** *"The algorithm is a bit weird, and the weirdness isn't something to be
...
Your words: *"These things aren't how things should work. They're not sensible, but specifically,
...
## Step 0 — read your Wikidata contributions, then diff against the ideal

1. **Check your Wikidata profile for everything you have edited**, and add it to the ledger.
   `Special:Contributions/日巫女`, never a bulk download — `CLAUDE.md` § *you edit the tree and
...
**The ideal state is what Wikidata already holds plus what Geni supports** — your ruling,
...
was what you meant. Not the Geni tree alone
...
## Step 1 — creation of individuals. REVISED 2026-08-26, after you stopped a run

**You terminated a 50-creation run partway through**: *"I had to terminate that round early
...
**The numbers you dictated were 10s. They have been doubled twice since** — 2026-09-05,
...
basically"*. The shape below is yours; the figures are the current constants, which live in
...
**Spouses have no bucket of their own.** Your first version said *"10 parents, 10 spouses, 10
children"*; you revised it in the same message — *"spouses are only added through the 10
...
as the **substitution** when a picked person's marriage has no child left. Your words: *"spouses
...
line down to you stayed at **0 of 16 steps** — the *"critical path going to me"* you doubted the
...
You stopped a run over it and it is gone. What stands is above: ten children, ten parents, free
