...
*how is this person related to you*; on Charlemagne, *how is this person related to Charlemagne*.
...
Your 2026-09-03 words — *"You do not pin Charlemagne, it needs to be done exactly once and I did
it"* — were about a session that stalled on the page, and you set it yourself to unblock the work.
That got recorded in `CLAUDE.md` and `queue.md` as though the pin were untouchable, so when the
first real capture came back anchored on the viewer it was reported as **NEEDS-DECISION, yours**
and left sitting. It was never yours to decide. It was a thing to check and set.

**The general fault, worth more than this instance: a shortcut you took to unblock me became a
constraint I enforced against you.** When you do something by hand because the automation is
...
3. **VERIFY on a real target, never on the pin.** Load a profile with a known viewer-anchored
   ...
   resolved to a **23-step chain to you** at 14:xx, and after the anchor moved the same page read
...
flipped it mid-run would silently re-anchor every capture after it, which is the failure your
...
`yes` predates the anchor and is an **You-anchored** result; his Charlemagne answer is a blood
miss with in-law unchecked. His path file
`paths/isolate-geni-rudolf-beck-1919-c1941.tsv` stays — You-anchored paths are live work by you
...
*"is your 15th cousin 7 times removed"*. The two targets running beside you, Anna Throndsen
...
and it answers *how is this person related to you*. Had the three been filed by the ordinary
