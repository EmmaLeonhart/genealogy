...
**Deepest = generations of recorded ancestry above the person.** That is the
far edge of the one ball that reached this cluster, and the place a different
entry point buys the most. It is a different ranking from `reports/density.md`,
which ranks by **doorways** — people whose parents are unrecorded — because
that answers coverage rather than reach.

**Presence measures our sampling, never Geni's content.** A cluster reached
once is one *we* barely covered; whether Geni holds more there is exactly the
...
| deepest members | generations above |
| --- | ---: |
| <private> Pritchard-Davies (`6000000019220580736`) | 73 |
| <private> Pritchard-Davies (`6000000019220986437`) | 73 |
| <private> Pritchard-Davies (`6000000019221098017`) | 73 |
| Private (`6000000014169439804`) | 73 |
| Private (`6000000014169572051`) | 73 |
| Private (`6000000019976257458`) | 73 |
|  (`4536460`) | 72 |
|  (`4536464`) | 72 |
...
| deepest members | generations above |
| --- | ---: |
| Àlvaro Rodrigues da (`6000000001435397492`) | 123 |
...
| deepest members | generations above |
| --- | ---: |
|  (`6000000186062713919`) | 12 |
|  (`6000000186063168839`) | 12 |
| Aina Margareta Andersson (`6000000180575010822`) | 12 |
| Loke Hans Gusten (`5014552342870108799`) | 12 |
| Private (`5014554994590086627`) | 12 |
| Private (`5014557763540119287`) | 12 |
...
| deepest members | generations above |
| --- | ---: |
| Private (`6000000082497288171`) | 67 |
| Private (`6000000082497288179`) | 67 |
| Private (`6000000082497288186`) | 67 |
|  (`6000000223055013596`) | 67 |
| Jeanette Adella Green (`6000000223055013705`) | 67 |
|  (`6000000223055013725`) | 67 |
...
| deepest members | generations above |
| --- | ---: |
| Richard Wallis (`6000000004118796746`) | 68 |
| Thomas (`6000000004118876975`) | 68 |
...
| deepest members | generations above |
| --- | ---: |
| <private> Ascarrunz Amer (`6000000217921018857`) | 29 |
| <private> Ascarrunz Amer (`6000000226089236862`) | 29 |
| <private> Rada Ascarrunz (`6000000000844378008`) | 29 |
| <private> Ascarrunz (`6000000006796357395`) | 29 |
| <private> Rada Ascarrunz (`6000000040750421375`) | 29 |
| <private> Rada Ascarrunz (`6000000076285470464`) | 29 |
...
| deepest members | generations above |
| --- | ---: |
|  (`6000000051854560822`) | 13 |
| jake (`6000000224254961847`) | 13 |
|  (`6000000224255115910`) | 13 |
| Elizabeth Anne-Maree (`6000000008078953549`) | 13 |
| Lyndon James (`6000000008078961484`) | 13 |
| Trillian Joy (`6000000008080786819`) | 13 |
...
| deepest members | generations above |
| --- | ---: |
| James Alexander (`6000000002148846800`) | 18 |
| Brendan Dalton (`6000000006978893564`) | 18 |
| Debbie Claire (`6000000050685523868`) | 18 |
| Lisa Anne (`6000000050685537930`) | 18 |
| Justin Hunter (`6000000099226073000`) | 18 |
|  (`6000000099226535853`) | 18 |
...
| deepest members | generations above |
| --- | ---: |
| Private (`6000000066549450002`) | 14 |
| Private (`6000000066549478978`) | 14 |
| Private (`6000000066549445893`) | 14 |
| Private (`6000000010550083897`) | 14 |
| Private (`6000000010550415558`) | 14 |
| Private (`6000000010550447491`) | 14 |
...
| deepest members | generations above |
| --- | ---: |
| Private (`6000000007209902942`) | 46 |
| Private (`6000000007209902963`) | 46 |
| Private (`6000000007210436274`) | 46 |
| Private (`6000000007210438472`) | 46 |
| Private (`6000000007210452240`) | 46 |
| Private (`6000000007210161720`) | 46 |
...
| deepest members | generations above |
| --- | ---: |
| Private (`6000000023992888335`) | 13 |
| frank benton (`6000000027503989553`) | 13 |
| Frank Benjamin Puett (`6000000030669990853`) | 13 |
| Sydney (`6000000065537932164`) | 13 |
|  (`6000000065538383067`) | 13 |
| Private (`6000000065538452962`) | 13 |
...
| deepest members | generations above |
| --- | ---: |
| Rune (`4265476158590065798`) | 72 |
| Private (`6000000006445092179`) | 72 |
| Private (`6000000006444969094`) | 72 |
| Private (`6000000020616619769`) | 72 |
| Sigmund (`4568500752980082024`) | 71 |
| Olav Helliesen (`6000000020616362676`) | 71 |
...
| deepest members | generations above |
| --- | ---: |
| Chaim (`6000000006935499879`) | 94 |
| Yehoshua Heschil Heschel (`6000000006935874263`) | 94 |
| Nochum (`6000000006935914217`) | 94 |
| Yehoshua Heschel Heschel (`6000000013030354642`) | 94 |
| David (`6000000032170142397`) | 93 |
| Rosa Babad (`6000000000967791750`) | 93 |
