...
Generated by `scripts/build-relationship-label-preview.py`. One row per placeholder person in `reports/relationship-label-preview.csv` — **39,398 people**.
...
| --- | ---: | ---: |
| people | 34,852 | 4,546 |
| a label can be generated | **27,849** (79%) | **2,244** (49%) |
| no relative with a real name | 7,003 | 2,302 |
