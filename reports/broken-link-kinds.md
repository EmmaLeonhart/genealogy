...
**No parent and no child link is missing anywhere.** The vertical structure of these paths is complete in our tree; only the lateral edges break.
...
`1 DIV` appears in **502** of the exports, so Geni does export former marriages and the format is not the limit.

- already linked as spouses in our tree: **0**
- neither person has **any** spouse recorded: **43** of 58
- one or both have spouses, but not each other: **15**

The large group is people our exports reached without reaching their marriages at all, which points at export coverage rather than at a modelling gap.
