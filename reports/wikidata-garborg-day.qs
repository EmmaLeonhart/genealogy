...
#   creation is good".
#   827 more are held for a later run; a repeat is a no-op, so nothing is lost.
# ------------------------------------------------------------------------
#   set the ja label to "ヘレナ・マリア・ソデルヒエルム"
Q112969835	Lja	"ヘレナ・マリア・ソデルヒエルム"
#   set the zh label to "海伦娜·玛丽亚·索德尔希埃尔姆"
Q112969835	Lzh	"海伦娜·玛丽亚·索德尔希埃尔姆"
#   set the ja label to "ヘレナ・マリアナ・シュパラー・アフ・ソフデボルグ"
Q116775360	Lja	"ヘレナ・マリアナ・シュパラー・アフ・ソフデボルグ"
#   set the zh label to "海伦娜·玛丽安娜·斯帕雷·阿夫·索夫德博尔格"
Q116775360	Lzh	"海伦娜·玛丽安娜·斯帕雷·阿夫·索夫德博尔格"
#   set the ja label to "カール・ヒシング"
Q110313452	Lja	"カール・ヒシング"
#   set the zh label to "卡尔·希辛"
Q110313452	Lzh	"卡尔·希辛"
#   set the ja label to "オースルヴ・スクレソン"
Q75291928	Lja	"オースルヴ・スクレソン"
#   set the zh label to "奥苏尔夫·斯库莱松"
Q75291928	Lzh	"奥苏尔夫·斯库莱松"
#   set the ja label to "ウルリカ・クリスティーナ・モルネル・アフ・モルランダ"
Q110386164	Lja	"ウルリカ・クリスティーナ・モルネル・アフ・モルランダ"
#   set the zh label to "乌尔里卡·克里斯蒂娜·莫尔内尔·阿夫·莫尔兰达"
Q110386164	Lzh	"乌尔里卡·克里斯蒂娜·莫尔内尔·阿夫·莫尔兰达"
#   set the ja label to "エリアス・ペデルソン・ガヴェリウス"
Q16649267	Lja	"エリアス・ペデルソン・ガヴェリウス"
#   set the zh label to "伊莱亚斯·佩德尔松·加韦利乌斯"
Q16649267	Lzh	"伊莱亚斯·佩德尔松·加韦利乌斯"
#   set the ja label to "マイケル・ファント"
Q5725186	Lja	"マイケル・ファント"
#   set the zh label to "迈克尔·凡特"
Q5725186	Lzh	"迈克尔·凡特"
#   Q141225713 Ingeborg Simonsdatter Ytre Lima: add a mul alias "Ingeborg Simonsdatter Ravndal"
Q141225713	Amul	"Ingeborg Simonsdatter Ravndal"
