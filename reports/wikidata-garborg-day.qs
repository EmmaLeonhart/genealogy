...
#   creation is good".
#   812 more are held for a later run; a repeat is a no-op, so nothing is lost.
# ------------------------------------------------------------------------
#   set the ja label to "ラウレンティウス・ヨネ・ハレニウス"
Q5783620	Lja	"ラウレンティウス・ヨネ・ハレニウス"
#   set the zh label to "拉乌伦蒂乌斯·约内·哈莱尼乌斯"
Q5783620	Lzh	"拉乌伦蒂乌斯·约内·哈莱尼乌斯"
#   set the ja label to "オロフ・ルドベク"
Q103771956	Lja	"オロフ・ルドベク"
#   set the zh label to "奥洛夫·鲁德贝克"
Q103771956	Lzh	"奥洛夫·鲁德贝克"
#   set the ja label to "ヨハン・グスタフ・ボイイェ・アフ・ゲネス"
Q130755124	Lja	"ヨハン・グスタフ・ボイイェ・アフ・ゲネス"
#   set the zh label to "约翰·古斯塔夫·博伊耶·阿夫·盖内斯"
Q130755124	Lzh	"约翰·古斯塔夫·博伊耶·阿夫·盖内斯"
#   set the ja label to "カタリーナ・エリーザベト・アロセル・アドレルヘイム"
Q131726951	Lja	"カタリーナ・エリーザベト・アロセル・アドレルヘイム"
#   set the zh label to "卡塔里娜·伊丽莎白·阿罗塞尔·阿德莱尔赫伊姆"
Q131726951	Lzh	"卡塔里娜·伊丽莎白·阿罗塞尔·阿德莱尔赫伊姆"
#   set the ja label to "フレデリカ・エレオノーラ・アルヴィドスドッテル・ホーン・アフ・エケビホルム"
Q109296398	Lja	"フレデリカ・エレオノーラ・アルヴィドスドッテル・ホーン・アフ・エケビホルム"
#   set the zh label to "夫雷德里卡·埃莱奥诺拉·阿尔维德斯多特·霍恩·阿夫·埃凯比霍尔姆"
Q109296398	Lzh	"夫雷德里卡·埃莱奥诺拉·阿尔维德斯多特·霍恩·阿夫·埃凯比霍尔姆"
#   set the ja label to "カール・フィリップ・ストロムフェルト"
Q130684265	Lja	"カール・フィリップ・ストロムフェルト"
#   set the zh label to "卡尔·菲利普·斯特罗姆费尔特"
Q130684265	Lzh	"卡尔·菲利普·斯特罗姆费尔特"
#   set the ja label to "アグニェータ・ヨハンスドッテル・オーロングレン"
Q130684369	Lja	"アグニェータ・ヨハンスドッテル・オーロングレン"
#   set the zh label to "阿格内塔·约汉斯多特·奥隆伦"
Q130684369	Lzh	"阿格内塔·约汉斯多特·奥隆伦"
#   set the ja label to "エヴァ・ホーン・アフ・エケビホルム"
Q19678400	Lja	"エヴァ・ホーン・アフ・エケビホルム"
