...
#   creation is good".
#   2663 more are held for a later run; a repeat is a no-op, so nothing is lost.
# ------------------------------------------------------------------------
#   Q5618560 Carl Constantin de Carnall: set the zh label to "卡尔·康斯坦丁·德·卡尔纳尔"
Q5618560	Lzh	"卡尔·康斯坦丁·德·卡尔纳尔"
#   set the ko label to "카르르 콘스탄틴 데 카르날르"
Q5618560	Lko	"카르르 콘스탄틴 데 카르날르"
#   set the ko label to "케키리에 올스다테르 호란드"
Q141206061	Lko	"케키리에 올스다테르 호란드"
#   set the ko label to "페데르 토르모드손 포스"
Q141206080	Lko	"페데르 토르모드손 포스"
#   set the ko label to "페트루스 케니큐스"
Q1345250	Lko	"페트루스 케니큐스"
#   Q5915800 Knut Algotsson: set the ko label to "크누트 알고촌"
Q5915800	Lko	"크누트 알고촌"
#   set the ko label to "토레 가르드손 가르드손"
Q141205942	Lko	"토레 가르드손 가르드손"
#   set the ko label to "가르드 토레손 탈게"
Q141216369	Lko	"가르드 토레손 탈게"
#   set the ja label to "ベネディクタ・オフ・ブイェルボ"
Q4981287	Lja	"ベネディクタ・オフ・ブイェルボ"
#   set the zh label to "贝内迪克塔·奥夫·布耶尔博"
Q4981287	Lzh	"贝内迪克塔·奥夫·布耶尔博"
#   set the ko label to "베네디크타 오프 브젤보"
Q4981287	Lko	"베네디크타 오프 브젤보"
#   Q141244239 Ulrika Charlotta Rotkirch: set the ko label to "울리카 차르로타 로트키르츠"
Q141244239	Lko	"울리카 차르로타 로트키르츠"
#   set the ko label to "다비드 쵤손 에드란드"
Q141217384	Lko	"다비드 쵤손 에드란드"
#   set the ko label to "베르타 구리아 다비드스다테르 스토카"
Q141216602	Lko	"베르타 구리아 다비드스다테르 스토카"
#   set the ko label to "토르게르 토르게르손 스토카"
Q141216653	Lko	"토르게르 토르게르손 스토카"
