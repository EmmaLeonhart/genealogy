...
One row per person in `reports/derived-facts.csv` — **1,685,914 people**, 
of whom 55,662 carry a Wikidata item.
...
| --- | ---: | ---: |
| sex | 1,683,024 | 99.8% |
| occupation | 199,803 | 11.9% |
| birth date | 1,149,114 | 68.2% |
| birth place | 0 | 0.0% |
| death date | 909,989 | 54.0% |
| death place | 0 | 0.0% |
| burial date | 112,683 | 6.7% |
| burial place | 0 | 0.0% |
