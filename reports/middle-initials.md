...
| --- | ---: | ---: |
| the only given token | 9,412 | 35.7% |
| first of several | 4,120 | 15.6% |
| after the first — the middle-initial case | 12,805 | 48.6% |

7,296 (27.7%) are one of `I V X L C D M`, so in isolation they are indistinguishable from a regnal ordinal; `reports/regnal-ordinals.md` counts that same overlap from the other side.
