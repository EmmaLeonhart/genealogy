# Creating the fathers the patronymics imply

Built by `scripts/build-patronymic-father-batch.py`. **Nothing runs before 1 September.**

- fathers created: **9158**  (1036 of them shared by siblings)
