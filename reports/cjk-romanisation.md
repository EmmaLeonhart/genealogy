...
- people with a CJK name and no Latin label: **38,458**
- culture settled: **37,184**
- romanised: **13,638** — zh **13,416**, ko **0**, ja **222**

## How culture was settled, in Emma's order of evidence

| evidence | people |
| --- | ---: |
| neighbours' script | 25,288 |
| a Chinese clan seat (郡望) | 8,892 |
| unclassified | 1,389 |
| a Japanese given-name ending | 1,042 |
| a simplified-only Chinese character | 302 |
| a character that exists only in Japanese | 186 |
| a listed birth or death place | 85 |
| **total** | **37,184** |
