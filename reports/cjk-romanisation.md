...
- people with a CJK name and no Latin label: **41,419**
- culture settled: **39,969**
- romanised: **15,392** — zh **15,162**, ko **0**, ja **230**

## How culture was settled, in the specified order of evidence

| evidence | people |
| --- | ---: |
| neighbours' script | 27,009 |
| a Chinese clan seat (郡望) | 9,754 |
| unclassified | 1,654 |
| a Japanese given-name ending | 1,049 |
| a simplified-only Chinese character | 317 |
