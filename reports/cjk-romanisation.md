...
- people with a CJK name and no Latin label: **38,802**
- culture settled: **37,490**
- romanised: **13,677** — zh **13,447**, ko **0**, ja **230**

## How culture was settled, in the specified order of evidence

| evidence | people |
| --- | ---: |
| neighbours' script | 25,500 |
| a Chinese clan seat (郡望) | 9,004 |
| unclassified | 1,451 |
| a Japanese given-name ending | 1,044 |
| a simplified-only Chinese character | 305 |
