...
- step 1 `en` edits: **175413**
- `mul` mirrored from them: **9339**
- deliberately not mirrored: **166074**

## Why 166074 are left alone
...
| --- | ---: |
| en, which came from romanised from zh | 8663 |
| en, which came from wikidata's own English label | 469 |
| en, which came from romanised from ja | 207 |
