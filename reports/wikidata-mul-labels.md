...
- step 1 `en` edits: **177469**
- `mul` mirrored from them: **9347**
- deliberately not mirrored: **168122**

## Why 168122 are left alone
...
| --- | ---: |
| en, which came from romanised from zh | 8674 |
| en, which came from wikidata's own English label | 464 |
| en, which came from romanised from ja | 209 |
