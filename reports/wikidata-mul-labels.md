...
- step 1 `en` edits: **176838**
- `mul` mirrored from them: **8474**
- deliberately not mirrored: **168364**

## Why 168364 are left alone
...
| --- | ---: |
| en, which came from romanised from zh | 8051 |
| en, which came from wikidata's own English label | 225 |
| en, which came from romanised from ja | 198 |
