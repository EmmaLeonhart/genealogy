...
Generated by `scripts/measure-zipper-reliability.py`. **Nothing here is reasoned from what sounds right.** 2026-08-25: *"a lot of these rules are empirical and we need to empirically study our data to figure out what to make of it. Don't jump to conclusions based on what sounds like it might be true. Even parents isn't certain."*
