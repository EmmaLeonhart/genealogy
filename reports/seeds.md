...
A Geni export is a **breadth-first ball**: one profile, one style, and Geni walks outward until the export is full, modelled here at 4008 individuals. So the useful question is not who has the biggest subtree in our data — that is what we already hold — but whose ball would contain the most of what we do not.
