...
One row per person in `reports/derived-labels.csv` — **1,625,530 people**.

## What each person has to build a label from

| | people | share |
| --- | ---: | ---: |
| Latin only | 1,524,637 | 93.8% |
| CJK only — needs translation for en | 46,944 | 2.9% |
| no usable name at all | 28,167 | 1.7% |
| other script only — needs translation for en | 12,778 | 0.8% |
| mixed-script only — no clean Latin label | 10,342 | 0.6% |
...
## Aliases from married names — 307,255 people
...
50,566 people have both a derived Latin label and a Wikidata English
label. **13,311 match exactly (26.3%).**
