...
One row per person in `reports/derived-labels.csv` — **1,570,194 people**.

## What each person has to build a label from

| | people | share |
| --- | ---: | ---: |
| Latin only | 1,473,865 | 93.9% |
...
| mixed-script only — no clean Latin label | 10,162 | 0.6% |
...
## Aliases from married names — 298,035 people
...
48,532 people have both a derived Latin label and a Wikidata English
label. **13,047 match exactly (26.9%).**
