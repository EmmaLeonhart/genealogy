...
One row per person in `reports/derived-labels.csv` — **1,578,112 people**.

## What each person has to build a label from

| | people | share |
| --- | ---: | ---: |
| Latin only | 1,479,738 | 93.8% |
| CJK only — needs translation for en | 45,990 | 2.9% |
| no usable name at all | 26,912 | 1.7% |
...
## Aliases from married names — 298,930 people
...
48,755 people have both a derived Latin label and a Wikidata English
label. **13,054 match exactly (26.8%).**
