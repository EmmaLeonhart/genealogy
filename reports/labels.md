...
One row per person in `reports/derived-labels.csv` — **1,758,561 people**.

## What each person has to build a label from

| | people | share |
| --- | ---: | ---: |
| Latin only | 1,649,644 | 93.8% |
| CJK only — needs translation for en | 52,022 | 3.0% |
| no usable name at all | 28,991 | 1.6% |
| other script only — needs translation for en | 13,369 | 0.8% |
| mixed-script only — no clean Latin label | 11,392 | 0.6% |
...
## Aliases from married names — 315,103 people
...
67,690 people have both a derived Latin label and a Wikidata English
label. **20,728 match exactly (30.6%).**
