...
One row per person in `reports/derived-labels.csv` — **1,753,948 people**.

## What each person has to build a label from

| | people | share |
| --- | ---: | ---: |
| Latin only | 1,645,146 | 93.8% |
| CJK only — needs translation for en | 52,001 | 3.0% |
| no usable name at all | 28,991 | 1.7% |
| other script only — needs translation for en | 13,311 | 0.8% |
| mixed-script only — no clean Latin label | 11,356 | 0.6% |
...
66,451 people have both a derived Latin label and a Wikidata English
label. **20,235 match exactly (30.5%).**
