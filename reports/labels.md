...
One row per person in `reports/derived-labels.csv` — **1,565,085 people**.

## What each person has to build a label from

| | people | share |
| --- | ---: | ---: |
| Latin only | 1,468,768 | 93.8% |
| CJK only — needs translation for en | 44,406 | 2.8% |
| no usable name at all | 26,493 | 1.7% |
| other script only — needs translation for en | 12,601 | 0.8% |
| mixed-script only — no clean Latin label | 10,159 | 0.6% |
...
## Aliases from married names — 296,824 people
...
48,076 people have both a derived Latin label and a Wikidata English
label. **13,014 match exactly (27.1%).**
