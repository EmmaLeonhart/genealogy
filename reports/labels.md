...
One row per person in `reports/derived-labels.csv` — **1,567,011 people**.

## What each person has to build a label from

| | people | share |
| --- | ---: | ---: |
| Latin only | 1,470,684 | 93.9% |
| CJK only — needs translation for en | 44,406 | 2.8% |
| no usable name at all | 26,500 | 1.7% |
| other script only — needs translation for en | 12,603 | 0.8% |
| mixed-script only — no clean Latin label | 10,160 | 0.6% |
...
## Aliases from married names — 296,997 people
...
48,163 people have both a derived Latin label and a Wikidata English
label. **13,029 match exactly (27.1%).**
