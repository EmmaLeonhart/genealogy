...
One row per person in `reports/derived-labels.csv` — **1,518,940 people**.

## What each person has to build a label from

| | people | share |
| --- | ---: | ---: |
| Latin only | 1,424,598 | 93.8% |
| CJK only — needs translation for en | 44,205 | 2.9% |
| no usable name at all | 25,464 | 1.7% |
| other script only — needs translation for en | 12,130 | 0.8% |
| mixed-script only — no clean Latin label | 9,886 | 0.7% |
...
## Aliases from married names — 289,461 people
...
44,857 people have both a derived Latin label and a Wikidata English
label. **12,381 match exactly (27.6%).**
