...
Geni caps a GEDCOM export at 3836 individuals, so covering this tree means many
exports rather than a few, and the question "which profile do I export from
next?" is worth answering with evidence instead of intuition.
