...
#:
#: **2026-08-06 — the mechanism is stated, and it is not a Geni-side mystery:
#: the bound is four times the number of profiles the account has added.** That
#: explains what the measurements below could not. Every observed value is a multiple
#: of four because the rule multiplies by four. It is not per-style and not
#: per-seed because it is a property of the account's contributions. It rises
#: across a session because profiles are being added as it goes — which is also
...
#: better than any fixed limit does, and the spacing is roughly the interval
#: between exports - so this may be tracking Geni's own growth rather
...
#: (`6000000227240691895`), a profile created that day, taken at 16:08.
...
#: the ceiling is four times the profiles added, and Samaritan profiles had been
#: added all day.
...
#: high priests being built that night. It was re-exported because one
...
#: it. Consistent with the ceiling tracking the profiles added, and not
#: evidence of a rule about the number.
#: **2026-08-15, evening — 5000**, and it is a round number for the first time.
#: Eight `Forest` exports in the edge batch came back at exactly 5000:
...
#: **2026-08-17 — 5000 again, four times, from a new kind of seed.** The first
