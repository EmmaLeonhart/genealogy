...
**The idea inverts how the other reports work.**
...
#: Names that identify nobody. A pair is only useful if the two people can be
#: recognised and found on Geni, and `Private` is Geni's redaction of a living
