...
#: :data:`genimerge.crosscheck.SUSPECT_IS_NOT_WRONG` itself — a test asserts it
...
def render_claim_markdown(batch: ClaimBatch, *, top: int = 80) -> str:
    from .claims import Statement  # noqa: F401  (documented shape)

    lines = [
        "# Proposed claims: parents, spouses and dates",
        "",
