...
#: was added 2026-08-07, with approval, before the bulk download — a
#: ~10,300-request run is exactly the case the policy is written for.
#: The User-Agent is the contact address and nothing else: the
...
#: skips reading the Wikidata contributions and produces a batch off a stale ledger
