...
# This module once carried a "one export?" flag marking any cluster wider than
# nine people as too big to close, on the basis that nine was the widest gap a
...
# a limit on what could be taken next, which is not the same claim, and it was
# never asked for. **Report what is missing and who the doorway is. Whether a gap
# is worth an export is decided by hand.**
