...
def relation_description(html: str) -> str:
    ...
    **Residuals get grabbed all the time**, because structurally strange things happen often
    enough that a narrowing parser loses real distinctions. This is the first of those, and
...
def html_of_saved_page(raw: str) -> str:
    ...
    *"no relationship path found"*, indistinguishable from a page saved while signed out or of
    two people Geni cannot connect. Two saved pages failed that way on 2026-08-27, and
